 ...
 */
     ...
     */
        ...
        public static function id()
        {
                    ...
                    /**
         * Logger a user into the application without sessions or cookies.
         *
        ...
        public static function once($credentials = [])
        {
                    ...
                    /**
         * Logger the given user ID into the application without sessions or cookies.
         *
         * @param mixed $id
        ...
        public static function attempt($credentials = [], $remember = false)
        {
                    ...
                    /**
         * Logger the given user ID into the application.
         *
         * @param mixed $id
         * @param bool $remember
         * @return \App\User|false
        ...
        public static function loginUsingId($id, $remember = false)
        {
                    ...
                    /**
         * Logger a user into the application.
         *
        ...
        public static function login($user, $remember = false)
        {
                    ...
                    /**
         * Logger the user out of the application.
         *
         * @return void
         * @static
         */
     ...
     */
        ...
        {            //Method inherited from \Illuminate\Database\Connection
                    ...
                    /**
         * Logger a query in the connection's query log.
         *
         * @param string $query
         * @param array $bindings
